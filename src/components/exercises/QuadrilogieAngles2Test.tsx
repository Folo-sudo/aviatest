...
const SETTINGS_KEY = 'aviatest-quadrilogie-angles-2-settings';
...
function generateLevel2(clockUpAngle: 0 | 90 | 180 | 270, isReversed: boolean): { data: Level2Data; correctAngle: number } {
  const targetAngle = pickAngle10(10, 350);
  // FIX v2: angle measured from [base -> tip] (arrow = origin) to [base -> point] (point = arrival).
  ...
  // Pick tip direction in clock-angles, then derive point direction by adding target.
...
function generateLevel4(_clockUpAngle: 0 | 90 | 180 | 270, isReversed: boolean): { data: Level4Data; correctAngle: number } {
  // FIX v2: the target is the rotation (in clock-positive direction) needed to bring H
  // to the TOP OF THE SCREEN, regardless of where the '12' of the clock is drawn. The clock
...
const EXERCISE_ID = 'quadrilogie-angles-2';

export function QuadrilogieAngles2Test() {
...
export default QuadrilogieAngles2Test;
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4">
      <Card className="w-full max-w-lg">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-bold">Quadrilogie des Angles v2</CardTitle>
...
function drawCorrectionArc(
  ...
  if (d.level === 1) {
    ...
    // FIX v2: origin = arrow direction (base -> tip), arrival = point direction.
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4">
      <Card className="w-full max-w-3xl">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl">Quadrilogie des Angles v2</CardTitle>
